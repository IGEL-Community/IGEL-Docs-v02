...
```
The new PRIVATE BUILD 11.10.439 for IGEL Workspace is ready.
...
## 2025-11-19 - [11.10.438](readme11.10.438.txt)

```
The new PRIVATE BUILD 11.10.438 for IGEL Workspace is ready.
...
* Add support for Distributed App Repositories to OS11.
* Added new registry keys for distributed App repositories:
...
```
The new PRIVATE BUILD 11.10.436 for IGEL Workspace is ready.

This build is based on 11.10.434.
...
## 2025-10-17 - [11.10.435](readme11.10.435.txt)

```
The new PRIVATE BUILD 11.10.435 for IGEL Workspace is ready.
...
## 2025-10-13 - [11.10.434](readme11.10.434.txt)

```
The new PRIVATE BUILD 11.10.434 for IGEL Workspace is ready.
...
```
The new PRIVATE BUILD 11.10.317 for IGEL Workspace is ready.

This build is based on 11.10.316.
...
## 2025-07-31 - [11.10.412](readme11.10.412.txt)

```
The new PRIVATE BUILD 11.10.412 for IGEL Workspace is ready.

This build is based on 11.10.410.
...
* Bugfix for audio issue on LG CQ60x
```

-----

## 2025-07-24 - [11.10.316](readme11.10.316.txt)

```
The new PRIVATE BUILD 11.10.316 for IGEL Workspace is ready.
...
* The registry key "ica.authman.KioskSFUIEnhanced" has been removed and replaced
  with "ica.authman.KioskSFUIEnhancedDisabled" due to change in the parameter
  name. Ensure to update the registry value accordingly if it is currently in
  use.
* Citrix App Protected resources can be launched from the browser without the
  need for a pre-configured store in the setup. A system restart is required
  after activating/deactivating this feature.
...
```
The new PRIVATE BUILD 11.10.292 for IGEL Workspace is ready.
...
* Added Cisco JVDI Client 14.1.2
```
...
```
The new PRIVATE BUILD 11.10.291.DER for IGEL Workspace is ready.
...
## 2025-05-12 - [11.10.274.DER](readme11.10.274.DER.txt)

```
The new PRIVATE BUILD 11.10.274.DER for IGEL Workspace is ready.
...
## 2025-04-30 - [11.10.273](readme11.10.273.txt)

```
The new PRIVATE BUILD 11.10.273 for IGEL Workspace is ready.

This build is based on 11.10.231.
...
## 2024-09-25 - [11.09.273](readme11.09.273.txt)
...
## 2024-08-07 - [11.10.164](readme11.10.164.txt)
...
## 2024-07-26 - [11.10.154](readme11.10.154.txt)
...
* Updated Cisco Webex VDI to 44.6.0.30048  
  Support for AVD added (technical preview - not yet officially supported by
  Cisco)

### zoomvdi

* Updated ZoomVDI to 5.17.13.25060
```

----

## 2024-07-23 - [11.10.153](readme11.10.153.txt)
...
* Updated to Cisco Webex VDI 44.2.0.29959
```
