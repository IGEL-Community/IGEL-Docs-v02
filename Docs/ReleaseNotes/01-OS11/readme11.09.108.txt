...
Release Notes 11.09.108 (Based On 11.08.360)
--------------------------------------------------------------------------------
...
+-------------------------------------------+----------------------------------+
| Chromium                                  | 118.0.5993.70-1igel1697046811    |
+-------------------------------------------+----------------------------------+
...
+-------------------------------------------+----------------------------------+
| WebKit2Gtk                                | 2.42.1-2+b1igel1696854696        |
+-------------------------------------------+----------------------------------+
| Python2                                   | 2.7.18                           |
+-------------------------------------------+----------------------------------+
| Python3                                   | 3.10.12                          |
...
+-------------------------------------------+----------------------------------+
| Open VM Tools                             | 12.1.5-3~ubuntu0.22.04.3         |
+-------------------------------------------+----------------------------------+
| Open VM Desktop Tools                     | 12.1.5-3~ubuntu0.22.04.3         |
+-------------------------------------------+----------------------------------+
...
| AVD                                         |  41.8M | Included         |
+---------------------------------------------+--------+------------------+
| Local Browser (Chromium)                    |  98.2M | Not included     |
+---------------------------------------------+--------+------------------+
