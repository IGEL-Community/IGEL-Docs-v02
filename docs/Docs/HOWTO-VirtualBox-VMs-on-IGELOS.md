...
- Image USB device [Windows OS](https://kb.igel.com/en/igel-os/11.10/create-usb-installation-medium-windows) or [MacOS](Docs/HOWTO-Create-USB-Installation-medium-MacOS)
