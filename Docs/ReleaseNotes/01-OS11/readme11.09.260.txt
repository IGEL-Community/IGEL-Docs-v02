...
Firmware version 11.09.260  
Release date 2024-03-07  
Last update of this document 2024-03-07  
...
+-----------------------------+--------+------------------+
| NVIDIA graphics driver      | 374.0M | Included         |
+-----------------------------+--------+------------------+
...
| Java SE Runtime Environment                 |  54.2M | Included         |
+---------------------------------------------+--------+------------------+
| Citrix StoreFront                           | 651.5M | Included         |
| Citrix Appliance                            |        |                  |
...
+---------------------------------------------+--------+------------------+
| Citrix Appliance                            |  87.0M | Included         |
...
* IGEL Agent for Imprivata does not work in auth only mode with VMware Horizon.
