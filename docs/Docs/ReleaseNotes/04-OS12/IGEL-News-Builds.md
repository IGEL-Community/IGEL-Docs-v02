...
## 2026-09-01 - [12.10.0 PR1](https://app.igel.com/base_system/12.10.0+1)

```
The new BUILD 12.10.0 PR1 (Rolling Release) for IGEL Workspace is ready.
...
## 2026-08-21 - [12.8.3](https://app.igel.com/base_system/12.8.3)

```
The new BUILD 12.8.3 (Stable Release) for IGEL Workspace is ready.
...
| Input Driver VMMouse                      | 13.1.0-1ubuntu2igel1628499891    |
| Input Driver Wacom                        | 1.2.4-1igel1772694990            |
| Kernel                                    | 6.18.6 #mainline-lxos12-g1785933202C     |
| Xorg X11 Server                           | 21.1.23-1igel1780396689          |
| Lightdm Graphical Login Manager           | 1.26.0-8igel1772701866           |
| ISC DHCP Client                           | 4.4.3-P1-2                       |
| ModemManager                              | 1.24.2-2igel1763114076           |
...
# Changes since: 12.8.2 LTS

## New Features

- **WiFi**

	- Added a parameter for showing only managed wireless networks in the wifi tray app.
	When enabled, the user cannot connect to unmanaged SSIDs.
```

| Parameter | Registry | Type | Value |
| ------ | ------ | ------ | ------ |
| `Show only managed wireless networks` | `network.interfaces.wirelesslan.device0.show_only_managed_ssids` | bool | enabled / *disabled* (default) |

```
- **Smartcard**

	- Added a parameter to enable or disable support for the Kerberos smart card PKINIT PAChecksum2 extension. This parameter must be enabled when using Windows Server 2025 or later.
```
...
- **Hardware**
	...
	- Added a parameter to configure the Intel DSP driver on the ClearCube CD7042.
```
...
- **Dual Boot BC/DR (IGEL OS)**
	...
	- Enhanced Boot Menu Design for BC&DR
	- Improved GRUB reliability and operational behavior.

## Security Fixes

- Fixed krb5 security issue CVE-2026-11850.
- Fixed libvncserver security issues CVE-2026-50538 and CVE-2026-44988.
...
- Fixed python3.11 security issues CVE-2026-6100, CVE-2026-4519, CVE-2026-4224, CVE-2026-3644, CVE-2026-2297, CVE-2026-0672, CVE-2025-13462, CVE-2023-52425, CVE-2026-1299, CVE-2026-0865, CVE-2026-0672, CVE-2025-8291, CVE-2025-8194, CVE-2025-6075, CVE-2025-6069, CVE-2025-4516, CVE-2025-15282, CVE-2025-13837, CVE-2025-13836, CVE-2025-12084 and CVE-2025-11468.
- Fixed openssl security issues CVE-2026-9076, CVE-2026-7383, CVE-2026-45447, CVE-2026-45446, CVE-2026-45445, CVE-2026-42770, CVE-2026-42766, CVE-2026-34182 and CVE-2026-34180.
- Fixed taglib security issue CVE-2023-47466.
- Fixed rsync security issues CVE-2026-45232, CVE-2026-43620, CVE-2026-43619, CVE-2026-43618, CVE-2026-43617 and CVE-2026-29518.
- Fixed sed security issue CVE-2026-5958.
- Fixed openssl1.1 security issues CVE-2026-28390, CVE-2026-28389, CVE-2026-28388, CVE-2026-28387, CVE-2026-22796, CVE-2026-22795, CVE-2025-9230, CVE-2025-69421, CVE-2025-69420, CVE-2025-69419, CVE-2025-69418, CVE-2025-68160, CVE-2024-9143, CVE-2024-5535, CVE-2024-4741, CVE-2024-2511, CVE-2024-13176, CVE-2024-0727, CVE-2023-5678, CVE-2023-3817, CVE-2023-3446, CVE-2023-2650, CVE-2023-0466, CVE-2023-0465, CVE-2023-0464, CVE-2023-0286, CVE-2023-0215, CVE-2022-4450, CVE-2022-4304, CVE-2022-2097, CVE-2022-2068, CVE-2022-1292, CVE-2022-0778, CVE-2021-4160, CVE-2021-3712, CVE-2021-3711, CVE-2021-3450, CVE-2021-3449, CVE-2021-23841, CVE-2021-23840, CVE-2020-1971 and CVE-2020-1967.
- Updated ca-certificates package to version 20260601.
- Fixed openvpn security issues CVE-2026-13698, CVE-2026-13122, CVE-2026-12996, CVE-2026-12932, CVE-2026-12117 and CVE-2026-11771.
- Updated wireless-regdb package to version 2026.05.30.
- Fixed jq security issues CVE-2026-54679, CVE-2026-49839, CVE-2026-47770, CVE-2026-44777, CVE-2026-43896, CVE-2026-43895, CVE-2026-43894, CVE-2026-41257, CVE-2026-41256, CVE-2026-40164, CVE-2026-39979, CVE-2026-39956, CVE-2026-33948, CVE-2026-33947 and CVE-2026-32316.
- Fixed librabbitmq security issues CVE-2026-44236 and CVE-2026-44235.
- Fixed python-urllib3 security issue CVE-2026-44431.
- Fixed gst-libav1.0 security issue CVE-2026-52717.
- Fixed gst-plugins-bad1.0 security issues CVE-2026-53701, CVE-2026-52719 and CVE-2026-52718.
- Fixed gst-plugins-good1.0 security issues CVE-2026-5056, CVE-2026-46470, CVE-2026-46469, CVE-2026-39044, CVE-2026-39043 and CVE-2026-1940.
- Fixed libarchive security issues CVE-2026-5745 and CVE-2026-14164.
- Fixed nss security issues CVE-2026-6772, CVE-2026-6767, CVE-2026-6766 and CVE-2026-12318.
- Fixed libcaca security issue CVE-2026-42046.
- Fixed curl security issues CVE-2026-7168, CVE-2026-5773, CVE-2026-3784, CVE-2026-3783, CVE-2025-14819, CVE-2025-14524 and CVE-2025-10148.
- Fixed giflib security issues CVE-2026-26740 and CVE-2026-23868.
- Fixed graphite2 security issue CVE-2026-50593.
- Fixed xz-utils security issue CVE-2026-34743.
- Fixed protobuf security issues CVE-2026-6409, CVE-2026-0994, CVE-2025-4565 and CVE-2024-7254.
- Fixed libxfont security issues CVE-2026-56003, CVE-2026-56002 and CVE-2026-56001.
- Fixed libxml2 security issues CVE-2026-1757, CVE-2026-0992, CVE-2026-0990, CVE-2026-0989, CVE-2025-8732 and CVE-2025-49794.
- Fixed python-xmltodict security issue CVE-2025-9375.
- Fixed sshfs-fuse security issues CVE-2026-48711 and CVE-2026-47187.
- Fixed openssh security issues CVE-2026-60002, CVE-2026-60001, CVE-2026-60000, CVE-2026-59999, CVE-2026-59998, CVE-2026-59997, CVE-2026-59996 and CVE-2026-59995.
- Fixed spice-vdagent security issues CVE-2026-57966 and CVE-2026-57965.

## Resolved Issues

- Added a refresh button to the Display Tray application to recover displays that could sporadically appear black in multi-monitor setups.
- Fixed autostart notification of sessions in case session restart is active.
- Fixed the user session not being properly closed when the system was suspended with no login method configured.
- Fixed Hyper-V guest OS capabilities (Hyper-V is not officially supported).
- Fixed USB Access Control deny rules not correctly blocking USB storage devices or interface devices such as smart card readers.
- Fixed login mask not appearing on Dell devices when disclaimer is enabled.
...
- **Network**
	...
	- Fixed PAC file evaluation results not being applied correctly.
	- Fixed a potential crash when searching for hidden Wi-Fi networks by SSID.
	- Fixed PPP compatibility with NetworkManager by reverting to version 2.4.9 with the latest security updates.

- **Smartcard**

	- Fixed Active Directory/Kerberos logon with smartcard to Windows Server 2025 based Active Directory domains by implementing PKINIT PAChecksum2 extension. Added a parameter to switch support of the extension:
```
...
- **Audio**
	...
	- Fixed internal microphone not found issue with HP 255 G10 laptop.

- **Hardware**

	- Fixed issue where the system and taskbar remained unresponsive for up to 90 seconds after the first resume following a reboot.
...
- **Remote Management**
	...
	- Improved stability when multiple commands are sent close to each other which modify device state.
	- Fixed a bug where the system failed to prompt for a package manager update after a network change (for example, when connecting to a VPN).
	- Fixed measuring of the UTC Unix Epoch time.
	- Fixed transferring of the system information to the UMS.
	- Fixed a rare case where remote manager stopped responding if multiple files failed download.

- **Dual Boot BC/DR (IGEL OS)**

	- Fixed BC&DR boot menu falling back to text mode due to missing theme files
	- Fixed the dual boot loader not recognizing Windows boot entries containing hexadecimal digits.

- **IGEL Desktop**

	- Fixed desktop folders for sessions that could not be opened.
	- Fixed mixed colors in tray panel for certain theme and color combinations.
	- Fixed  bug of using non-supported display resolutions by filtering them out.
...
## 2026-07-31 - [12.10.0](https://app.igel.com/base_system/12.10.0)

```
The new BUILD 12.10.0 (Rolling Release) for IGEL Workspace is ready.
...
## 2026-06-24 - [12.9.0 PR3](https://app.igel.com/base_system/12.9.0+3)

```
The new BUILD 12.9.0 PR3 (Rolling Release) for IGEL Workspace is ready.
...
# Changes since: 12.9.0 PR 2

## New Features

- Added DPI settings into Accessibility tray app.
  - Affected parameters: `x.xserver0.dpi` and `x.server0.auto_dpi`

## Resolved Issues

- Fixed Bluetooth devices becoming unpaired and disconnected after device configuration changes.
- Fixed paired Bluetooth devices not being retained across reboots.
- Fixed dynamicParam for app.honeywell_utc.sound.touch_sink.device_name not writing device name to configuration

- **App Management**

	- Fixed: App and base OS installation failed with DEV license on IGEL OS versions above 12.7.3 when the device was not connected to UMS.

- **Multimedia**

	- Fixed H.264 video decoding failures caused by a missing GStreamer video parser plugin.
...
- **OSC Installer**
	...
	- On Lenovo T14 Gen 6 Intel devices, the OSC may display a black screen with no desktop during a standard boot. A failsafe boot is required to access the OSC installer system.
	- Corporate identity files are not copied on the device
	- The update duration of the base_system might increase, especially on older hardware up to 2 minutes
...
- **Accessibility**
	...
	- The screen reader (accessibility feature) currently does not work with the following apps:
		...
		- IGEL System Tray apps (volume, network,  notifications, ...)
		- VPN and SSO login dialogs
	- No support for the Screen Reader in TC Setup.
...
## 2026-06-17 - [12.8.2 PR1](https://app.igel.com/base_system/12.8.2+1)

```
The new BUILD 12.8.2 PR1 (Stable Release) for IGEL Workspace is ready.
...
## 2026-06-16 - [12.9.0 PR2](https://app.igel.com/base_system/12.9.0+2)

```
The new BUILD 12.9.0 PR2 (Rolling Release) for IGEL Workspace is ready.
...
## 2026-06-11 - [12.8.2](https://app.igel.com/base_system/12.8.2)

```
The new BUILD 12.8.2 (Stable Release) for IGEL Workspace is ready.
...
## 2026-06-10 - [12.9.0 PR1](https://app.igel.com/base_system/12.9.0+1)

```
The new BUILD 12.9.0 PR1 (Rolling Release) for IGEL Workspace is ready.
...
## 2026-06-08 - [12.9.0](https://app.igel.com/base_system/12.9.0)

```
The new BUILD 12.9.0 (Rolling Release) for IGEL Workspace is ready.
...
- Added support for Bluetooth Access Control with Bluetooth device filter rules. When Bluetooth Access Control is enabled, only devices matching the configured whitelist rules can be paired and connected. Devices that were previously paired but no longer match the configured "Major Class of Device" and "Minor Class of Device" criteria are automatically unpaired and disconnected:
```

|  IGEL Setup  |  Parameter  |  Registry   |  Type       |  Value      |
| ------ | ------ | ------ | ------ | ------ |
|  Devices > Bluetooth > Access Control  |  `Class of Device Whitelist`  |  `devices.bluetooth.access_control.cod_filter%`  |   |   |
|  Devices > Bluetooth > Access Control  |  `Enable Bluetooth Access Control`  |  `devices.bluetooth.access_control.enabled`  |  bool  |  enabled / *disabled* (default)  |
...
- **OSC Installer**
	...
	- Added: The new `modify_osc_image` tool allows customization of OSC installation images. It can be used to preinstall applications, certificates, and settings, as well as to enable unattended installations.
	- Note: Use this tool with caution. Installing an OSC image overwrites existing operating system installations and data partitions on the target device.
	- Added: The new `modify_osc_image` tool now allows configuring the default action after an OSC installation. Administrators can choose whether the system reboots or shuts down once the installation has completed. The default behavior remains shutdown.

- **App Management**

	- Added HTTPS support for deployments and updates performed through the Distributed Peer Update feature.

- **Network**

	- Added: To provide network bonding functionality, the following registry keys have been added to the system configuration:
```

|  Parameter  |  Registry   |  Type       |  Value      |  Range      |
| ------ | ------ | ------ | ------ | ------ |
|  `LACP rate`  |  `network.interfaces.bonding.bond%.lacp_rate`  |  |  *slow*  | [fast (1s)]  |
|  `Bond index`  |  `network.interfaces.ethernet.device%.bond_index`  |  integer  |  empty *Default*  |  |
|  `This is the primary device in the bond`  |  `network.interfaces.ethernet.device%.bond_primary`  |  bool  |  enabled / *disabled* (default)  |  |
|  `Bond mode`  |  `network.interfaces.bonding.bond%.mode`  |  |  *active-backup*  |  [active-backup] |
|  `Bond link monitoring`  |  `network.interfaces.bonding.bond%.link_monitoring`  |  |  *MII*  | [balance-rr][802.3ad][balance-xor][balance-tlb][balance-alb][broadcast]  |
|  `ARP targets`  |  `network.interfaces.bonding.bond%.arp_targets`  |  string  |  empty *Default*  |  [MII] |
|  `Monitoring frequency (ms)`  |  `network.interfaces.bonding.bond%.monitoring_frequency`  |  integer  |  100 *Default*  | [ARP]  |
|  `Link up delay (ms)`  |  `network.interfaces.bonding.bond%.link_up_delay`  |  integer  |  0 *Default*  |  |
|  `Link down delay (ms)`  |  `network.interfaces.bonding.bond%.link_down_delay`  |  integer  |  0 *Default*  |  |
|  `Transmit hash policy`  |  `network.interfaces.bonding.bond%.xmit_hash_policy`  |  |  *layer2*  |  [layer2] |

```
- **WiFi**

	- Added new parameter for showing only managed wireless networks in the wifi tray app.
	When enabled, the user cannot connect to unmanaged SSIDs.
```
...
- **Smartcard**
	...
	- Added a smartcard username hint field at AD/Kerberos logon with smartcard. This enables the user to log in to accounts other than those registered in the smartcard certificate. To enable this feature, configure the following parameter:
```

| Setup | Parameter | Registry | Value |
| ------ | ------ | ------ | ------ |
| Security>Logon>Active Directory/Kerberos | Enable smartcard username hint | auth.login.smartcard_userhint | true/false(default) |
...
- **Hardware**
	...
	- Added support for Braille displays with Orca screenreader.
```

|  IGEL Setup  |  Parameter  |  Registry   |  Range      |  Value      |  Type       |
| ------ | ------ | ------ | ------ | ------ | ------ |
|  User Interface > Accessibility > Screen Reader > Braille      |  `Show Braille Monitor in Orca.`  |  `windowmanager.a11y.screenreader.braille.show_braille_monitor`  |  [None][Dot 7][Dot 8][Dots 7 and 8]  |  enabled / *disabled* (default)  |  bool  |
...
- **Remote Management**
	...
	- Added initial support for UMS Persona Profiles.
	- Added the option "Challenge Password" in the certificate enrollment over UMS as CA proxy if the CA configured for using SCEP as enrollment protocol.
	- Added "Challenge Password" parameter to certificate enrollment over UMS as CA proxy.
...
- Fixed openssh security issues CVE-2026-35414, CVE-2026-35388, CVE-2026-35387, CVE-2026-35385 andCVE-2026-3497.
...
- Fixed bind9 security issues CVE-2026-1519 and CVE-2025-13878.
...
- Fixed libarchive security issue CVE-2026-4111.
- Fixed ntfs-3g security issue CVE-2026-40706.
- Fixed Kernel security issue CVE-2026-31431 also known as copy fail.
...
- Fixed possible coredumps during logoff
- Fixed an incorrect error message that was displayed when an user entered an incorrect password during AD login.
- Fixed inability to log in after closing and reopening the laptop lid.
- Removed the unsupported display resolution 800x600 from the list of available display resolutions.
- Fixed incorrect decimal separator for Polish(Programmers) keyboard layout from dot to comma.
- Fixed freezes caused by firmware hangs on affected AMD devices using the amdgpu driver (including Lenovo T14 Gen 6 AMD) by backporting three kernel commits.
  - Added a potential workaround for the freezes by disabling CWSR (see below) on affected AMD Krackan Point devices using the amdgpu driver (including Lenovo T14 Gen 6 AMD).
  - Added new setup parameter `x.drivers.amdgpu.cwsr_enable` to allow forcing the Compute Wave Store and Resume (CWSR) feature/optimization on or off. By default, the kernel setting is used (enabled if supported).
  - Added new setup parameter `x.drivers.amdgpu.gpu_recovery` to allow toggling a `amdgpu_gpu_recover` file in debugfs - which can be **read** to force a GPU reset - on or off. By default, the kernel setting is used (disabled).
```
...
```
- Fixed sporadic failure to mount USB memory sticks and other removable memory
- Fixed slow default mouse speed.
- Fixed degraded systemd status caused by igel-hooksd.service
- Fixed an issue that prevented tray applications from being accessible on the login screen.
- Improved Device Encryption activation for TPM PCR auto-unlock.
- Fixed parameter parsing issues that could lead to settings being lost.
...
- **OSC Installer**
	...
	- Resolved an issue in OS12 Creator where legacy settings could be migrated despite "Migrate Old Settings" being disabled.
	- Fixed that the system powers down during the installation via PXE.
	- Fixed display of available licenses for license migration in IGEL OS Creator.
	- Fixed an issue where devices installed in PXE mode could shut down after installation instead of automatically rebooting.

- **AVD**

	- Fixed an issue where AVD did not restart automatically after resuming from suspend.
...
- **App Management**
	...
	- Fixed an issue that could cause devices to install the latest Base OS on reboot after a new Base App was assigned, even when "Update.Action after app assignment from UMS" was set to "Nothing" (`update.autoactivate_future_config=nothing`), requiring an additional step to download and activate new apps.
	- Fixed an issue where devices migrated from IGEL OS 11 could become stuck in an update loop on IGEL OS 12 (12.8.0 and earlier), preventing updates from completing as expected.
	- Fixed an issue that could overwrite migrated settings during OS installation.
	- Improved PXE installation reliability by ensuring network-based deployments follow the correct installation workflow.

- **Network**

	- Fixed a race condition in the global proxy configuration that could occur during network initialization and connectivity state changes.
	- Fixed an issue where changes to `network.global.reverse_pci_detection` only became effective after a reboot.

- **Smartcard**

	- Fixed smartcard PKCS#11 multiplexing library to work with Citrix CWA smartcard login.
	- Fixed Active Directory/Kerberos logon with smartcard to Windows Server 2025 based Active Directory domains.
	- Fixed instabilities in smart card daemon.
...
```
	- Support for Lenovo ThinkCentre Neo 50q Gen5: Fixed left and right sound channels not working as expected.

- **Hardware**

	- Fixed the Dell Wyse 5470 AIO side buttons for brightness control and display toggle.
	- Fixed Microphone Mute special key on supported HP devices.
	- Fixed and improved touchscreen mapping format for multi-touchscreen setups:
	 Touchscreens can now be mapped to displays by their XInput device name in addition to the existing USB port path based configuration.
	    - This can improve stability when USB port paths change, for example when using docking stations.
...
- **Remote Management**
	...
	- Fixed handling for 'Update on shutdown' command.
	- Fixed possible stale connection to the local VNC or Telnet service while tunneling to the UMS through a remote management connection.
	- Fixed reporting app state for apps marked for removal or installation on the next boot.
	- Fixed and optimized applying of assigned certificate files.
	- Fixed stopping of the remote management service during suspend.

- **IGEL Desktop**

	- Fixed wrong resolution shown in Display Identifier Window after changing resolution in Setup page User Interface > Display.
	- Fixed inconsistent behavior between different tray apps when clicking on tray app icons.
	- Fixed display configuration hot-plug issues by clearing display cache when monitors are added or removed.
	- Fixed: Always prioritize display settings set via UMS / TC-Setup over local settings after reboot.
	- Fixed missing contrast of highlighted text in input fields for IGEL Dark theme
	- Fixed screen flickering caused by premature restart of system components while display changes are still running
	- Fixed long delay for desktop icons when starting up VDI environment
	- Fixed crash of cancelled password dialog for sessions.
	- Fixed wrong color of auto-hidden taskbar (not respecting current theme).
	- Fixed empty timezone view in time-date tray app when `system.time.timezone_in_tray` is not set by showing currently applied timezone.
	- Fixed Accessibility and Time-Date tray to not cover title and navigation link with scrollable content
	- Added two new instances to `sessions.wmcommands` for tiling a local window to the left / right.
```
...
```
	- Fixed taskbar to use available space after collapsing and expanding tray panel
	- Fixed bug where non-allowed windows raised above IAFI lock screen.
	- Fixed wrong alignment of buttons and texts in shutdown dialog for languages with long texts like Swedish.
	- Fixed wrong IAFI lock-screen in multi-monitor setups.
	- Fixed wrong alignment of dual-monitor setups after configuring displays in TC-Setup.
...
- **setupd**
	...
	- Fixed broken update of file mark when resetting a user value.
...
## 2026-04-29 - [12.8.1](https://app.igel.com/base_system/12.8.1)

```
The new BUILD 12.8.1 (Stable Release) for IGEL Workspace is ready.
...
## 2026-04-08 - [12.8.0](https://app.igel.com/base_system/12.8.0)

```
The new BUILD 12.8.0 (Stable Release) for IGEL Workspace is ready.
...
## 2026-04-08 - [12.7.6](https://app.igel.com/base_system/12.7.6)

```
The new BUILD 12.7.6 (Rolling Release) for IGEL Workspace is ready.
...
## 2026-02-10 - [12.7.5](https://app.igel.com/base_system/12.7.5)

```
The new BUILD 12.7.5 for IGEL Workspace is ready.
