...
Firmware version 11.05.180  
Release date 2021-08-19  
Last update of this document 2021-08-19  
...
+-------------------------------------------+----------------------------------+
| IGEL AVD Client                           | 1.0.27igel1626991842             |
+-------------------------------------------+----------------------------------+
...
+-------------------------------------------+----------------------------------+
| Gstreamer 0.10 Fluendo vadec              | 0.10.227                         |
+-------------------------------------------+----------------------------------+
...
+-------------------------------------------+----------------------------------+
| Gstreamer 1.0 Fluendo vadec               | 0.10.227                         |
+-------------------------------------------+----------------------------------+
...
+-------------------------------------------+----------------------------------+
| VirtualBox VM within IGEL OS              | 6.1.18-dfsg-3igel52              |
+-------------------------------------------+----------------------------------+
...
+------------------------------------------------------------------------+
| Citrix Appliance                           | 370.0M | Included         |
...
+------------------------------------------------------------------------+
| Cisco WebEx VDI                            |  45.0M | Not included     |
+------------------------------------------------------------------------+
| Cisco Webex Meetings VDI                   |  75.0M | Not included     |
+------------------------------------------------------------------------+
| Zoom Media Plugin                          | 107.5M | Not included     |
+------------------------------------------------------------------------+
...
Release Notes 11.05.180 (Based On 11.05.170)
--------------------------------------------------------------------------------
...
* No post session commands are executed when using CWA 21.06.  
  The Citrix Workspace app 21.06 returns a 2 instead of the expected 0 as exit
  code, therefore the post session commands are not executed.  
  To continue executing them, a new instance must be created in the registry
  under pcom.valid_return_codes%.

+------------+-----------------------------------------------------------------+
| Parameter  | Value                                                           |
+============+=================================================================+
| pcom.valid_return_codes2.binary| wfica                                                           |
+------------+-----------------------------------------------------------------+
| pcom.valid_return_codes2.returncodes| 2                                                               |
+------------+-----------------------------------------------------------------+

* The binary wfica and the return code 2 must be entered in the new instance .  
**Attention**, the instance number may differ from the example.
* App Protection is not supported yet
...
* Integrated **Citrix Workspace app 21.08**  
  Available Citrix Workspace Apps in this release: 21.08 (default), 21.03, and
  20.10  
* App Protection is not yet supported

### Cisco Webex

* Integrated **Cisco WebEx VDI 41.8.0.19732**
* Integrated **Cisco Webex Meetings VDI Clients**.  
  
  Available Cisco WebEx Meetings VDI clients in this release: 41.8.4.11
...
* An improved implementation of the post-session command mechanism has been
  integrated.
