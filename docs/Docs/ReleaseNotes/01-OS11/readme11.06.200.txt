...
Firmware version 11.06.200  
Release date 2021-11-24  
Last update of this document 2021-11-23  
...
+-------------------------------------------+----------------------------------+
| IGEL AVD Client                           | 1.0.32igel1635162457             |
+-------------------------------------------+----------------------------------+
...
+--------------------------------------------+--------+------------------+
| Citrix StoreFront                          | 375.8M | Included         |
| Citrix Appliance                           |        |                  |
...
+--------------------------------------------+--------+------------------+
| Zoom Media Plugin                          | 121.8M | Not included     |
+--------------------------------------------+--------+------------------+
| DriveLock                                  |  13.2M | Included         |
+--------------------------------------------+--------+------------------+
| SpeechWrite Client                         | 256.0K | Included         |
+--------------------------------------------+--------+------------------+
| Fluendo Browser Codec Plugins              |   5.0M | Included         |
+--------------------------------------------+--------+------------------+
...
use UMS 6.09.100 or later and updating the corresponding profiles.
...
Release Notes 11.06.200 (Based On 11.06.150)
--------------------------------------------------------------------------------
...
* With Citrix Workspace app versions 21.04.0 and 21.09.0, smartcard
  authentication fails to forward the PIN correctly into the session for login.
  Instead the user has to input the PIN a second time within the session. The
  problem does not occur with Citrix Workspace App 20.10.0.
...
* The on-screen keyboard in Horizon appliance mode does not work correctly with
  local logon.  
  It is necessary to switch off local logon and enable the following this two keys via IGEL  
  registry:  
  userinterface.softkeyboard.autoshow  
  userinterface.softkeyboard.autohide
* Zoom VDI Media Plugin versions below 5.8.0 makes Horizon Client crash upon
...
* The right screen when using multiscreen environment may not be shown correctly.  
  Workaroung: The horizontal offset should be set to the width of the monitor (e.g. if the
  monitor has a width of 1920, the offset should be set to 1920)
...
* Browser Appliance mode can fail when the Web URL contains special control
  ...
  Workaround: Add quotes at the beginning and the end of an affectedURL. 
  E.g.:'https://www.google.com/search?q=aSearchTerm&source=lnms&tbm=isch'
...
* UD3-M340C: Sound preferences are showing Headphone & Microphone, although not
  connected.
* After plugging in a USB headset, the sound does not change to this, although
  this is indicated in the sound preferences and in Pulseaudio.
