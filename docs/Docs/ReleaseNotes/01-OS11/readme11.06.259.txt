...
Firmware version 11.06.259  
Release date 2022-02-25  
Last update of this document 2022-02-25  
...
Release Notes 11.06.259 (Based On 11.06.250)
--------------------------------------------------------------------------------
...
* Fixed a bug where comma-separated strings in custom policies broke some
...
+-------------------------------------------+----------------------------------+
| IGEL RDP Client                           | 2.2igel1639469055                |
+-------------------------------------------+----------------------------------+
...
* Keyboard Input Source Language Synchronization works only with usage a local
  layout with deadkeys enabled.  
...
* Client drive mapping and USB redirection for storage devices can be switched
  on at the same time, but could lead to problems under some circumstances:  
