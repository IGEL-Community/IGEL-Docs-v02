...
[Devices] 
- Added: If multiple backups are configured and present, the user can now select a specific backup when restoring a virtual machine. (IGEL Managed Hypervisor) 
