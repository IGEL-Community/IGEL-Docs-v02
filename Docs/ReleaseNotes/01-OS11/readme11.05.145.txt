...
Firmware version 11.05.145  
Release date 2021-05-18  
Last update of this document 2021-05-18  
...
+-------------------------------------------+----------------------------------+
| Cisco Webex Meetings VDI Client           | 40.11.5.2704                     |
+-------------------------------------------+----------------------------------+
...
+------------------------------------------------------------------------+
| Citrix Workspace app                       | 287.8M | Included         |
| Citrix StoreFront                          |        |                  |
| Citrix Appliance                           |        |                  |
+------------------------------------------------------------------------+
...
+------------------------------------------------------------------------+
| Cisco Webex Teams VDI                      |  43.8M | Not included     |
+------------------------------------------------------------------------+
| Cisco Webex Meetings VDI                   |  82.0M | Not included     |
+------------------------------------------------------------------------+
| Zoom VDI Media Plugin                      |  47.2M | Not included     |
+------------------------------------------------------------------------+
...
Release Notes 11.05.145 (Based On 11.05.140)
--------------------------------------------------------------------------------
...
* Available Cisco WebEx Meetings VDI clients in this release: 41.4.0.162
  (default), 41.2.0.142 and 40.11.5.2704
* New registry keys:
...
+------------+-----------------------------------------------------------------+
|Value       |**41.4.0.162**ÿ(default), 41.2.0.142 and 40.11.5.2704            |
+------------+-----------------------------------------------------------------+
...
Release Notes 11.05.140 (Based On 11.05.139)
--------------------------------------------------------------------------------
...
* Remove permission to start mousepad editor for non root users.  
...
Release Notes 11.05.139 (Based On 11.05.138)
--------------------------------------------------------------------------------
...
* Citrix H.264 acceleration plugin does not work with **enabled** server policy
  "Optimize for 3D graphics workload" in combination with server policy "Use
  video codec compression" -> *"For the entire screen"**.
* ctxlogd not started automatically: Use custom command to start ctxlogd.
...
* New version of Evidians rsUserAuth 1.5.7789,  
  this fixes the "Ignore Smartcard Removal" feature.
...
* Improved start of Citrix logging daemon ctxlogd with CWA 21.04
...
* TRRS Microphone bugfix. Duplex profile now selected after plugin.

### Hardware

* Fix ADS-TEC VMT 9000 driver.
...
Release Notes 11.05.138 (Based On 11.05.133)
--------------------------------------------------------------------------------
...
* Improved startup of Citrix USB daemon.
* Integrated **Citrix Workspace app 21.04**  
  
  Available Citrix Workspace Apps in this release: 21.04 (default), 21.03 and
  20.12  
  
* Note : With this release, the echo cancellation feature for Microsoft Teams is
  disabled by default. We recommend that you not use built-in speakers and
  microphone for calls. Use headphones instead.
