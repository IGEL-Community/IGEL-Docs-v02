...
Firmware version 11.07.920  
Release date 2022-09-15  
Last update of this document 2022-09-15  
...
Release Notes 11.07.920 (Based On 11.07.910)
--------------------------------------------------------------------------------
...
+-------------------------------------------+----------------------------------+
| Open VPN                                  | 2.6.0~git20220808-1igel1660123886 |
+-------------------------------------------+----------------------------------+
| Zulu JRE                                  | 8.0.345-1                        |
+-------------------------------------------+----------------------------------+
...
+-------------------------------------------+----------------------------------+
| Bluetooth Stack (bluez)                   | 5.64-0ubuntu1igel1660041146      |
+-------------------------------------------+----------------------------------+
...
+-------------------------------------------+----------------------------------+
| Graphics Driver ATI/AMDGPU                | 22.0.0-2igel1657776223           |
+-------------------------------------------+----------------------------------+
...
+-------------------------------------------+----------------------------------+
| Kernel                                    | 5.17.15 #mainline-lxos-g1659943300 |
+-------------------------------------------+----------------------------------+
...
Release Notes 11.07.910 (Based On 11.07.170)
--------------------------------------------------------------------------------
...
Release Notes 11.07.170 (Based On 11.07.140)
--------------------------------------------------------------------------------
...
* Authentication dialog is present inside Citrix Workspace app and the store
  ...
  encrypted and stored so that it is not necessary to reenter credentials when
...
* Automatically discovers the store associated with email address  
...
* For the case an issue occurs with Citrix Workspace app in production, it is
  possible to disable an affected feature dynamically in Citrix Workspace app
  during runtime. For that feature flags and a third-party service called
  LaunchDarkly are used.
...
+------------+-----------------------------------------------------------------+
|Registry    |`imprivata.cookieinsert`                                         |
+------------+-----------------------------------------------------------------+
|Type        |string                                                           |
+------------+-----------------------------------------------------------------+
...
* Integrated Cisco WebEx Meetings VDI Plugin 42.5.5.9  
  ...
  Available Webex Meetings Plugins in this release:ÿ42.5.5.9
  **(default)**,ÿ42.3.1.12 and 41.12.6.12
...
* Fixed chromium-browser security issues CVE-2022-1876, CVE-2022-1875,
...
+------------+-----------------------------------------------------------------+
|Parameter   |`Don't query the PTP interface`                                  |
+============+=================================================================+
|Registry    |`sessions.mtp-devices0.omit_ptp`                                 |
+------------+-----------------------------------------------------------------+
|Type        |bool                                                             |
+------------+-----------------------------------------------------------------+
|Value       |enabled / **disabled** (default)                                 |
