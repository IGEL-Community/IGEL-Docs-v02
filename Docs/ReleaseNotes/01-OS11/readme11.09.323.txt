...
Firmware version 11.09.323  
Release date 2024-07-02  
Last update of this document 2024-07-03  
...
Release Notes 11.09.323 (Based On 11.09.321)
--------------------------------------------------------------------------------
...
+-------------------------------------------+----------------------------------+
| Chromium                                  | 122.0.6261.128-1igel1710342739   |
+-------------------------------------------+----------------------------------+
| Cisco JVDI Client                         | 14.3.1                           |
+-------------------------------------------+----------------------------------+
| Cisco Webex VDI plugin                    | 44.2.0.29959                     |
+-------------------------------------------+----------------------------------+
...
+-------------------------------------------+----------------------------------+
| Citrix HDX Realtime Media Engine          | 2.9.700                          |
+-------------------------------------------+----------------------------------+
...
+-------------------------------------------+----------------------------------+
| IGEL Agent for Imprivata                  | 0.5.4igel1710255518              |
+-------------------------------------------+----------------------------------+
...
+---------------------------------------------+--------+------------------+
| Cisco JVDI client                           |  63.5M | Included         |
+---------------------------------------------+--------+------------------+
...
| AVD                                         |  42.2M | Included         |
+---------------------------------------------+--------+------------------+
| Local Browser (Chromium)                    | 101.8M | Not included     |
+---------------------------------------------+--------+------------------+
| Amazon WorkSpaces Client                    |  33.0M | Included         |
+---------------------------------------------+--------+------------------+
| deskMate Client                             |   5.8M | Included         |
+---------------------------------------------+--------+------------------+
| Cisco Webex VDI                             | 100.8M | Not included     |
+---------------------------------------------+--------+------------------+
| Cisco Webex Meetings VDI                    | 195.2M | Not included     |
+---------------------------------------------+--------+------------------+
| Zoom Media Plugin                           | 182.5M | Not included     |
+---------------------------------------------+--------+------------------+
...
Release Notes 11.09.321 (Based On 11.09.310)
--------------------------------------------------------------------------------
...
Release Notes 11.09.310 (Based On 11.09.260)
--------------------------------------------------------------------------------
...
**  [https://docs.citrix.com/en-us/citrix-workspace-app-for-linux/configure-
  xenapp.html#optimization-for-microsoft-teams|https://docs.citrix.com/en-
  us/citrix-workspace-app-for-linux/configure-xenapp.html#optimization-for-
  microsoft-teams|smart-link]  
