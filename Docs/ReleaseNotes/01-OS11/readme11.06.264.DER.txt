...
Firmware version 11.06.264.DER  
...
Release Notes 11.06.264.DER (Based On 11.06.262)
--------------------------------------------------------------------------------
...
* Downgrade Horizon Client to version 2012-8.1.0-17349998 to ensure
  compatibility to HP t610
...
+--------------------------------------------+--------+------------------+
| VMware Horizon                             | 191.2M | Included         |
+--------------------------------------------+--------+------------------+
...
Release Notes 11.06.262 (Based On 11.06.260)
--------------------------------------------------------------------------------
...
* Integrated Citrix Workspace app 22.03.  
  Available Citrix Workspace apps in this release: 22.03 (default), 21.12 and
  20.10
* Added registry keys for Citrix Workspace app 22.03:  
* to configure new KeyboardSyncMode. Windows Server may require config, see
  [https://docs.citrix.com/en-us/citrix-workspace-app-for-linux/configure-
...
* Updated Horizon Client to version 2111.1-8.4.1-19480456 with typematic (key-
  repeat) fix
...
* Fixed the lost possibility to view and handle client certificates by replacing
  the deprecated certificate manager with firefox' standard certificate dialog.

### CUPS Printing

* Fixed handling of more than one printer and printer selection by USB IDs.  
  
  Fixed classification of some HP printers as scanners only which made printing
  impossible because of missing access rights.
