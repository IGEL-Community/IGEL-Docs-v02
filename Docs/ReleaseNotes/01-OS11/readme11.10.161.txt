...
Release Notes 11.10.161 (Based On 11.10.151)
--------------------------------------------------------------------------------
...
* Added support for Horizon next-gen API  
  If the server URL of a Horizon session matches the host name patteren defined
...
+---------------------------------------------+--------+------------------+
| Citrix Appliance                            |  86.5M | Included         |
