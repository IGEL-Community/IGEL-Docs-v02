...
- Image USB device [Windows OS](https://kb.igel.com/en/igel-os/11.10/create-usb-installation-medium-windows) or [IGEL Community HOWTO](https://igel-community.github.io/IGEL-Docs-v02/Docs/HOWTO-Create-USB-Installation-medium/)
