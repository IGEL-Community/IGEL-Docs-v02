...
**NOTE:** Reverse proxy with SSL offloading is possible as of UMS 12.02. See [Configure the UMS to Integrate Reverse Proxy with SSL Offloading](https://kb.igel.com/endpointmgmt-12.04/en/configure-the-ums-to-integrate-reverse-proxy-with-ssl-offloading-126846455.html).
