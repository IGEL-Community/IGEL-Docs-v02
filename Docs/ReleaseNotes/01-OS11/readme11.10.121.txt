...
Firmware version 11.10.121  
Release date 2024-10-16  
Last update of this document 2024-10-16  
...
Release Notes 11.10.121 (Based On 11.10.120)
--------------------------------------------------------------------------------
...
* Cisco Webex VDI plugin: 44.6.0.30048ÿ
...
+-------------------------------------------+----------------------------------+
| Kernel                                    | 6.6.22 #mainline-lxos-g1717760843 |
+-------------------------------------------+----------------------------------+
...
+---------------------------------------------+--------+------------------+
| Citrix Appliance                            | 808.8M | Included         |
| Citrix StoreFront                           |        |                  |
...
+---------------------------------------------+--------+------------------+
| Zoom Media Plugin                           | 177.8M | Not included     |
+---------------------------------------------+--------+------------------+
...
+---------------------------------------------+--------+------------------+
| Fluendo Browser Codec Plugins               |   6.8M | Included         |
+---------------------------------------------+--------+------------------+
...
Release Notes 11.10.120 (Based On 11.10.100)
--------------------------------------------------------------------------------
