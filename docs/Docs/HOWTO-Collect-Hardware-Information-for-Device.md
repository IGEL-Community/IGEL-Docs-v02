...
- [KB: UMS - Save Support Information / Send Log Files to Support](https://kb.igel.com/en/universal-management-suite/current/save-support-information-send-log-files-to-support)
...
- [IGEL KB: How to Export Device Settings as a Profile in the IGEL UMS Web App](https://kb.igel.com/en/universal-management-suite/current/how-to-export-device-settings-as-a-profile-in-the-)

- [IGEL KB - Import Devices as Profiles](https://kb.igel.com/en/universal-management-suite/current/how-to-import-devices-as-profiles-in-the-igel-ums)

- [IGEL KB - Comparing Profiles in the IGEL UMS](https://kb.igel.com/en/universal-management-suite/current/comparing-profiles-in-the-igel-ums)
...
- [Download OS 11 -> Firmware Updates -> lxos_[VERSION]_public.zip](https://app.igel.com/software)
