...
- Removed: Ubuntu 20.04 from supported environments.
...
Updated: Azul Zulu JRE from version 21.0.11+10 to 21.0.12+8
Updated: embedded Tomcat version from 11.0.22 to 11.0.24
Fixed: keystore_update script could lead to wrong entries in the application_prod.yml file
```
...
- Updated: Azul Zulu JRE from version 21.0.10+7 to 21.0.11+10
- Updated: Apache Tomcat from version 11.0.21 to 11.0.22
- Updated: kryo-shaded (4.0.3) to the new kyro library (5.6.2)
```
...
Regular support for Ubuntu 20.04 has expired. Starting with ICG 12.13.100 in Q3 2026, IGEL will no longer supports these operating systems.
	See also: https://kb.igel.com/en/igel-subscription-and-more/current/support-policies-for-connections-to-third-party-en
...
- Updated: Spring Boot to version 4.0.5 (embedded tomcat 11.0.20)
- Updated: Azul Zulu JRE version 21.0.10+7 (minor update)
- Added: ICG supports Debian 13
...
- Fixed: Session was displayed as disconnected, although an active connection was present.
```

----

## 2026-03-31 - [12.11.100](Readme-12.11.100.txt)
...
Regular support for Ubuntu 20.04 has expired. Starting with ICG 12.12.100 in Q3 2026, IGEL will no longer supports these operating systems.
	See also: https://kb.igel.com/en/igel-subscription-and-more/current/support-policies-for-connections-to-third-party-en
...
- Updated: Spring Boot to version 3.5.10 (embedded tomcat 10.1.50)

- Updated: Azul Zulu JRE from version 21.0.8 to 21.0.10
```

----

## 2026-01-15 - [12.10.100](Readme-12.10.100.txt)
...
- Updated: Azul Zulu JRE from version 17.0.15+6 to 21.0.8+9

- Updated: Spring Boot to version 3.5.6 (embedded tomcat 10.1.46)

- Added: Http security browser headers
...
- Fixed: Increased the allowed file size for ICG to 2GB
```
