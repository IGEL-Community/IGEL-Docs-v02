...
| [diff](Cheatsheet-Linux-General.md#diff)                       | :material-check-bold: | :material-check-bold: | Compare files line by line |
...
| [microsoft-edge-stable](Cheatsheet-IGELOS-General.md#microsoft-edge-stable) | :material-close-circle: | :material-check-bold:| Start Edge Browser |
...
| [iptables](Cheatsheet-IGELOS-Networking.md#iptables)                                   | :material-check-bold: | :material-check-bold:| firewall configuration                                                                                  |
...
| [tcpdump](Cheatsheet-IGELOS-Networking.md#tcpdump) | :material-check-bold: | :material-check-bold:| tcpdump is a packet sniffer that shows you what traffic is happening |
